...
import { TagsStyleType } from '../datas/tags-style';


export class TagsStyle {

    // Attibutes
    tagsStyle: TagsStyleType;


    // Constructor
    constructor(tagsStyle: TagsStyleType) {
     ...
     * @returns 
     */
    remove(text: string | null): string | null {
        if (text === null) return null;
