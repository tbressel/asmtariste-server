...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 11 juil. 2024 à 21:39
...
CREATE TABLE `contents` (
  ...
  `text_left` mediumtext,
  `text_right` mediumtext,
  `text_center` mediumtext,
...
(5, 'certificats', '/certificates', 5, NULL),
...
(3, 'bob', 'bob@free.fr', '$2a$10$Y9aJ.0dOSFLGbI1YlmSa7u4Pu9na.a7k39XaguzQpy1qzsli7/6km', 0, 'null', 'null', '2024-07-08', 2);
...
--
ALTER TABLE `articles`
  MODIFY `id_articles` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `certificates`
  MODIFY `id_certificates` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `choices`
--
ALTER TABLE `choices`
  MODIFY `id_choices` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT pour la table `contents`
--
ALTER TABLE `contents`
  MODIFY `id_contents` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT pour la table `disk_units`
--
ALTER TABLE `disk_units`
  MODIFY `id_disk_units` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `files`
--
ALTER TABLE `files`
  MODIFY `id_files` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `menu_admin`
  MODIFY `id_menu_admin` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `questions`
--
ALTER TABLE `questions`
  MODIFY `id_questions` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tags`
  MODIFY `id_tags` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
